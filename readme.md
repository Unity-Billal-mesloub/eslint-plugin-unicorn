# eslint-plugin-unicorn [![Coverage Status](https://codecov.io/gh/Unity-Billal-mesloub/eslint-plugin-unicorn/branch/main/graph/badge.svg)](https://codecov.io/gh/Unity-Billal-mesloub/eslint-plugin-unicorn/branch/main) [![npm version](https://img.shields.io/npm/v/eslint-plugin-unicorn.svg?style=flat)](https://npmjs.com/package/eslint-plugin-unicorn)
...
**Requires ESLint `>=9.20.0`, [flat config](https://eslint.org/docs/latest/use/configure/configuration-files), and [ESM](https://gist.github.com/Unity-Billal-mesloub).**
